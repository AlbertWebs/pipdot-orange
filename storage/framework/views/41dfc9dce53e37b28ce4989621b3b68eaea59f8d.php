...
<?php $__currentLoopData = $SiteSettings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Settings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-1-2@m">
                                <div class="uk-overlay">
                                    <h1><?php echo html_entity_decode($item->name, ENT_QUOTES, 'UTF-8'); ?></h1>
                                    <p class="uk-text-lead uk-visible@m"><?php echo html_entity_decode($item->content, ENT_QUOTES, 'UTF-8'); ?></p>
                                    <div class="in-slideshow-button">
                                        <a target="blank" href="<?php echo e(url('/')); ?>/forex-courses" class="uk-button uk-button-primary uk-border-rounded">Our Courses</a>
                                        <a target="blank" href="<?php echo e(url('/')); ?>/articles" class="uk-button uk-button-default uk-border-rounded uk-margin-small-left uk-visible@m">Read Articles</a>
                                    </div>
                            ...
                            <div class="uk-position-center">
                                <img class="uk-animation-slide-top-small" src="<?php echo e(url('/')); ?>/uploads/slider/<?php echo e($item->image); ?>" data-src="<?php echo e(url('/')); ?>/uploads/slider/<?php echo e($item->image); ?>" alt="slideshow-image" width="862" height="540" data-uk-img>
                            </div>
                        </div>
                    </div>
                </li>
 ...
 Trade financial instruments as a professional!
    ...
    <div class="uk-section uk-padding-large in-padding-large-vertical@s uk-background-contain in-profit-2" data-src="<?php echo e(asset('theme/img/in-profit-decor-3.svg')); ?>" data-uk-img>
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-center">
                    ...
                    <div class="uk-child-width-1-3@s uk-child-width-1-3@m uk-margin-medium-top" data-uk-grid>
                            ...
                            <div class="in-pricing-1">
                                <div class="uk-card uk-card-default uk-box-shadow-medium">
                                    ...
                                    <div class="uk-card-media-top">
                                        <img class="uk-width-1-1 uk-align-center banner-images-heights" src="<?php echo e(asset('theme/img/img/in-lazy.svg')); ?>" data-src="<?php echo e(url('/')); ?>/uploads/banners/<?php echo e($Banners->image); ?>" data-width data-height alt="sample-image" data-uk-img>
                                        <span></span>
                                    </div>
                        ...
                        <div>
                            ...
                            <div class="in-pricing-1">
                                ...
                                <div class="uk-card uk-card-default uk-box-shadow-medium">
                                    <div class="uk-card-media-top">
                                        <img class="uk-width-1-1 uk-align-center banner-images-heights" src="<?php echo e(asset('theme/img/in-lazy.svg')); ?>" data-src="<?php echo e(url('/')); ?>/uploads/banners/<?php echo e($Banners->image); ?>" data-width data-height alt="sample-image" data-uk-img>
                                        <span></span>
                                    </div>
                                    <div class="uk-card-body uk-text-center">
                    ...
                    <div class="uk-grid-large uk-flex-middle uk-grid" data-uk-grid="">
                        ...
                        <div class="uk-width-expand@m">
                            <form class="uk-grid-small uk-grid" data-uk-grid="">
                                ...
                                <div class="uk-width-1-1 uk-width-auto@m">
                                    <a target="new" href="<?php echo e(url('/')); ?>/forex-courses/login" class="uk-button uk-button-primary uk-border-rounded uk-width-expand">Open Account</a>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="uk-grid-divider" data-uk-grid>
                ...
                <div class="uk-width-1-2@m" style="margin:0 auto !important;">
                    <div class="uk-child-width-1-1@s uk-child-width-1-1@m text-center" data-uk-grid style="margin:0 auto !important;">
                          ...
                          <?php echo $__env->make('front.chart-3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->make('front.layman', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('front.benefits', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('front.join', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('front.courses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('front.chart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('front.hows', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- section content begin -->
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/designekta-studios/projects/pipdotfx/resources/views/front/index.blade.php ENDPATH**/ ?>