        ...
        <div class="uk-grid-match uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m in-card-10 uk-grid uk-grid-stack" data-uk-grid="">
            ...
            <div class="uk-width-1-1 uk-flex uk-flex-center">
                <div class="uk-width-3-4@m uk-margin-medium-bottom uk-text-center">
                    ...
                    <p>
                        <a href="<?php echo e($Settings->twitter); ?>"><i class="fab fa-twitter"></i><span class="uk-text-lowercase">&nbsp; @pipdotfx</span></a>
                        &nbsp; &nbsp;<a href="<?php echo e($Settings->facebook); ?>"><i class="fab fa-facebook"></i><span class="uk-text-lowercase">&nbsp; @pipdotfx</span></a>
                        &nbsp; &nbsp;<a href="<?php echo e($Settings->instagram); ?>"><i class="fab fa-instagram"></i><span class="uk-text-lowercase">&nbsp; @pipdotfx</span></a>
                        &nbsp; &nbsp;<a href="<?php echo e($Settings->telegram); ?>"><i class="fab fa-telegram"></i><span class="uk-text-lowercase">&nbsp; @pipdotfx</span></a>
                        &nbsp; &nbsp;<a href="<?php echo e($Settings->youtube); ?>"><i class="fab fa-youtube"></i><span class="uk-text-lowercase">&nbsp; @pipdotfx</span></a>
                    </p>
                </div>
            </div>
                ...
                <div class="uk-width-3-4@m">
                    <div class="uk-grid uk-flex uk-flex-middle" data-uk-grid="">
                        <div class="uk-width-1-2@m uk-first-column">
                            ...
                            <a href="<?php echo e(url('/')); ?>/forex-courses/login" class="uk-button uk-button-primary uk-border-rounded">Enroll Now<i class="fas fa-chevron-circle-right fa-xs uk-margin-small-left"></i></a>
                        </div>
...
</div><?php /**PATH /home/designekta-studios/projects/pipdotfx/resources/views/front/layman.blade.php ENDPATH**/ ?>