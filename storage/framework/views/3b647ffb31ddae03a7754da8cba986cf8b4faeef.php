        ...
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-center in-contact-6">
                <div class="uk-width-1-1">
                    <iframe class="uk-width-1-1 uk-height-large uk-border-rounded" src="<?php echo e($Settings->map); ?>">
                    </iframe>
                </div>
                <div class="uk-width-3-5@m">
                    <div class="uk-grid uk-child-width-1-3@m uk-margin-medium-top uk-text-center" data-uk-grid>
                        <div>
                            ...
                            <p class="uk-margin-small-top"><?php echo e($Settings->address); ?> - <?php echo e($Settings->location); ?></p>
                        </div>
                        <div>
                            <h5 class="uk-margin-remove-bottom">Email</h5>
                            <p class="uk-margin-small-top uk-margin-remove-bottom"><?php echo e($Settings->email_one); ?></p>
                        ...
                        <div>
                            ...
                            <p class="uk-margin-small-top uk-margin-remove-bottom"><?php echo e($Settings->mobile_one); ?></p>
                    ...
                    <form id="contact-forms" class="uk-form uk-grid-small uk-margin-medium-top" data-uk-grid>
                        ...
                        <div class="uk-width-1-1">
                            <button class="uk-width-1-1 uk-button uk-button-primary uk-border-rounded" type="submit" name="submit">Send Message <img class="spinner" width="32" src="<?php echo e(asset('theme/img/ZZ5H.gif')); ?>" alt=""></button>
                        </div>
...
<script>
  ...
  $("#contact-forms").submit(function(stay){
      ...
      $.ajax({
         type: 'POST',
         url: "<?php echo e(url('/')); ?>/send-message/contact-form",
...
<?php echo $__env->make('front.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pipdotfx.com/public_html/resources/views/front/contact.blade.php ENDPATH**/ ?>