<?php if($paginator->hasPages()): ?>
    <nav>
        <ul class="uk-pagination uk-flex-center uk-margin-medium-top">
            ...
            <?php else: ?>
                <li>
                    <a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev" aria-label="<?php echo app('translator')->get('pagination.previous'); ?>"><i class="fas fa-angle-left fa-xs"></i></a>
                </li>
            <?php endif; ?>
                ...
                <?php if(is_array($element)): ?>
                    <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($page == $paginator->currentPage()): ?>
                            <li class="uk-active" aria-current="page"><span><?php echo e($page); ?></span></li>
                        <?php else: ?>
            ...
            <?php if($paginator->hasMorePages()): ?>
                <li>
                    <a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next" aria-label="<?php echo app('translator')->get('pagination.next'); ?>"><i class="fas fa-angle-right fa-xs"></i></a>
                </li>
            <?php else: ?>
